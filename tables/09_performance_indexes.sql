-- Migration 09: �ndices de performance e idempot�ncia
-- Execute este script UMA vez ap�s as migrations 01-08.
-- ?"??"? whatsapp_messages: �ndice �nico para idempot�ncia de mensagens recebidas ?"??"?
...
-- ?"??"? whatsapp_messages: busca por paciente/dire��o ?"??"??"??"??"??"??"??"??"??"??"??"??"??"??"??"??"??"??"??"??"??"??"??"??"??"??"??"?
ALTER TABLE whatsapp_messages
...
-- ?"??"? automation_logs: busca por usu�rio + tipo + timestamp (inatividade) ?"??"??"??"??"??"??"?
ALTER TABLE automation_logs
...
-- ?"??"? appointments: status + data_hora (automa��es de confirma��o/lembrete) ?"??"??"??"??"?
